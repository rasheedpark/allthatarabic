...
| 마지막 | 나쓰 (NASS — type=nass + nass+ 한 페이지) | 1장 |
...
**구성**: 헤더 → (type=nass 안내문 + 카드들) → (type=nass+ 안내문 + 카드들) → 푸터. 위→아래 스택.

- **type 별 안내문**:
  - `nass`: `다음을 들으면서 소리로 의미를 이해하고 같이 따라 읽어 보세요`
  - `nass+`: `다음을 듣고 다음에 나올 말이 무엇인지 유추해 보세요`
- **나쓰 카드** (흰색 박스)
  - 2열 그리드: **좌측 한국어 (LTR) / 우측 아랍어 + 음가 (RTL)**
...
| 나쓰 | type=`nass` 섹션 | `다음을 들으면서 소리로 의미를 이해하고 같이 따라 읽어 보세요` |
| 나쓰 | type=`nass+` 섹션 | `다음을 듣고 다음에 나올 말이 무엇인지 유추해 보세요` |
